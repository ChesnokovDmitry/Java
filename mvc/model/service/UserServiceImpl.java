...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public User deleteUser(long id) {                                   //удаляем пользователя
    ...
    @Override
    public User createOrUpdateUser(String name, long id, int level) {   //обновляем данные пользователя
        User user = new User(name, id, level);
        return userDao.createOrUpdate(user);
    }

    @Override
    public List<User> getUsersByName(String name) {                     //выбираем пользователя по имени
        return userDao.getUsersByName(name);
    }

    @Override
    public List<User> getAllDeletedUsers() {                            //заносим в список всех удаленных пользователей
    ...
    @Override
    public List<User> filterOnlyActiveUsers(List<User> allUsers) {      //список всех активных пользователей
    ...
    @Override
    public User getUsersById(long userId) {                             //выбираем пользователя по id
